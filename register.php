...
<body>
    ...
    <div class="container-sm bg-dark text-light align-content-center align-items-center text-center"
        ...
        <h1>Register Form</h1>
        <br>
        <form action="prosesDaftarUser.php" id="form_daftar" method="post">
            <div class="row mb-4">
                <label for="inputEmail3" class="col-sm-4 col-form-label">fullname</label>
                <div class="col-sm-8">
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="namapengguna" name="namapengguna" style="width:70%;"
                         required>
                </div>
            </div>
            <div class="row mb-4">
                <label for="inputPassword3" class="col-sm-4 col-form-label">institusi</label>
                <div class="col-sm-8">
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="alamatpengguna" name="alamatpengguna" style="width:70%;"
                         required>
                </div>
            </div>
            <div class="row mb-4">
                ...
                <div class="col-sm-8">
                    <input type="password" class="form-control" id="nohppengguna" name="nohppengguna" style="width:70%;"
                         required>
                </div>
            </div>

            <div class=" col-12 d-grid gap-2 d-md-flex justify-content-md-center">
                <input type="submit" class="btn btn-primary" value="Sign up" name="input">
